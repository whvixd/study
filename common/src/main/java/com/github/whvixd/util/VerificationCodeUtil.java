...
public class VerificationCodeUtil {
    ...
    private static ThreadLocal<VerificationCodeUtil> threadLocal = new ThreadLocal<>();
    ...
    public static VerificationCodeUtil Instance() {
        VerificationCodeUtil verificationCodeUtil = threadLocal.get();
        if(verificationCodeUtil==null){
            verificationCodeUtil = new VerificationCodeUtil();
            threadLocal.set(verificationCodeUtil);
        }
    ...
    public boolean write(File file) throws IOException {
        return ImageIO.write(getImage(), FILE_TYPE, file);
    }
